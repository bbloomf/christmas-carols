...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"To us is born a little Child"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(Parvulus nobis nascitur)"}}
