...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"The Truth From Above"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(Herefordshire Carol)"}}
