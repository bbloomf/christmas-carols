...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"O Holy Night"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(Cantique de Noël)"}}
