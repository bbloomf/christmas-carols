...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Jingle Bells"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(The One Horse Open Sleigh)"}}
...
%6.14 #(set-global-staff-size 14.1) \paper{ #(define fonts (make-pango-font-tree "Garamond Premr Pro" "Garamond Premr Pro" "Garamond Premr Pro" (/ 14.1 20))) }
global = {
  \key aes \major
  \time 2/4
