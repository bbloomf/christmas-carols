...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Rise Up, Shepherds, and Follow"}}
...
#(set-global-staff-size 14.7) \paper{ #(define fonts (make-pango-font-tree "GoudyOlSt BT" "Garamond Premier Pro" "Garamond Premier Pro" (/ 14.7 20))) }
global = {
  \key ees \major
  \time 4/4
