...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Carol of the Bells"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(Ukrainian Carol)"}}
