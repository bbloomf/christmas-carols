...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"’Twas in the winter cold"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "A Christmas Morning Hymn"}}
