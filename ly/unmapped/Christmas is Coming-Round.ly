...
\header {tagline = ""
    title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Christmas is Coming"}}
    %subtitle = \markup{{ \abs-fontsize #10.5 "(Three-part Round)"}}
