...
\header {
  tagline = ""
    ...
    title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Christmas Bells"}}
    subtitle = \markup{{ \abs-fontsize #10.5 "(Lovely Evening)"}}
  }
\paper {
  print-all-headers = ##f
  paper-height = 9\in
