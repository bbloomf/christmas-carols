...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #15 \smallCapsOldStyle"Puer natus in Bethlehem"}}
  subtitle = \markup{{ \abs-fontsize #10.5 "(A Babe is Born in Bethlehem)"}}
