...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"To us is born a little Child"}}
  subtitle = \markup{{ \abs-fontsize #12.5 "(Parvulus nobis nascitur)"}}
