...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"God Loved the World"}}
  subtitle = \markup{{ \abs-fontsize #12.5 "(Also hat Gott die Welt geliebt)"}}
