...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premier Pro Semibold"){ \abs-fontsize #18 \smallCapsOldStyle"Joy to the World!"}}
...
altoWordsIII = \lyricmode {
  ...
  Far as the curse is found,
  \dropLyricsXV
  Far as, __ far as, __ the curse is found.
}
