...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"The Son of God is born for all"}}
  subtitle = \markup{{ \abs-fontsize #12.5 "(Geborn ist Gottes Sönelein)"}}
