...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"O Come, O Come, Emmanuel"}}
...
\paper {
  ...
  headerLine = \markup{ \smallCapsOldStyle advent}
