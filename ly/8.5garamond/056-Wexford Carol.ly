...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premier Pro Semibold"){ \abs-fontsize #18 \smallCapsOldStyle"The Wexford Carol"}}
...
sopMusic = \relative c' {
  \repeat volta 3 {
    ...
    bes c bes4. d16[ c] |
    \tuplet 3/2 {bes8[ a] g} g( d4) e8 |
    f g f4 \bar"" \break b8\rest d, |
    
    g8 g16[ fis] g4. a8 |
    b c d4 b8\rest b |
    c d \slurDashed b8( g4) a8 |
...
tenorMusic = \relative c {
  ...
  d8 a f4. g8 |
  \tuplet 3/2 {g[ a] bes} bes[ a] bes[ c] |
  a c a4 r8 d, |
  
  g a b8.[ c16 d8] d |
  b g a4 s8 g |
  g g \slurDashed g8( g4) c8 |
  b c d4.
