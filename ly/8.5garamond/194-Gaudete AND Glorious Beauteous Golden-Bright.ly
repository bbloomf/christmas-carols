...
%6.14 \context {\Lyrics\override LyricText #'font-size = #0.6 }
  ...
  \header {
    title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Gaudete"}}
...
%    \new PianoStaff << \new Staff { \new Voice { \pianoRH } } \new Staff { \clef "bass" \pianoLH } >>
  ...
  \header {
    title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Glorious, Beauteous, Golden-Bright"}}
