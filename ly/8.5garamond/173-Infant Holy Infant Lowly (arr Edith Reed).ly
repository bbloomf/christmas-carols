...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Infant Holy, Infant Lowly"}}
  subtitle = \markup{{ \abs-fontsize #12.5 "(W Żłobie Leży)"}}
