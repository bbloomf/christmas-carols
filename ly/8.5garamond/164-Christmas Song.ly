...
\include "util.ly"
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smbd Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Christmas Song"}}
...
%6.14 #(set-global-staff-size 14.3) \paper{ #(define fonts (make-pango-font-tree "Garamond Premr Pro" "Garamond Premr Pro" "Garamond Premr Pro" (/ 14.3 20))) }
global = {
  \key c \major
  \time 6/8
  \autoBeamOff
